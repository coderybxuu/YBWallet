...
- (void)layoutSubviews {
    ...
    CGFloat YMinRetangle = isIphoneX ? (self.frame.size.height / 2.0 - sizeRetangle.height/(2.0 * _heightScale) - 68) : (self.frame.size.height / 2.0 - sizeRetangle.height/(2.0 * _heightScale) - 44);
