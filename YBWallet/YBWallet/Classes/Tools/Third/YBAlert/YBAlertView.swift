...
public enum YBAnimationStyle {
    case noAnimation, topToBottom, bottomToTop, leftToRight, rightToLeft
}

public enum YBActionType {
    case none, selector, closure
}

public enum YBAlertButtonLayout {
    case horizontal, vertical
}

open class YBButton: UIButton {
    var actionType = YBActionType.none
...
open class YBAlertViewResponder {
    let alertview: YBAlertView
    
    // Initialisation and Title/Subtitle/Close functions
    public init(alertview: YBAlertView) {
...
let uniqueAccessibilityIdentifier: String = "YBAlertView"

public typealias DismissBlock = () -> Void

// The Main Class
open class YBAlertView: UIViewController {
    
    public struct YBAppearance {
	...
	let kTitleMinimumScaleFactor: CGFloat
        ...
        var buttonsLayout: YBAlertButtonLayout
    ...
    public struct YBTimeoutConfiguration {
    ...
    var timeout: YBTimeoutConfiguration?
    var showTimeoutTimer: Timer?
    var timeoutTimer: Timer?
    var dismissBlock : DismissBlock?
    fileprivate var inputs = [UITextField]()
    fileprivate var input = [UITextView]()
    internal var buttons = [YBButton]()
    fileprivate var selfReference: YBAlertView?
    
    public init(appearance: YBAppearance) {
    ...
    fileprivate func setup() {
        ...
        if appearance.disableTapGesture == false {
            let tapGesture = UITapGestureRecognizer(target: self, action: #selector(YBAlertView.tapped(_:)))
...
//        let titleOffset : CGFloat = appearance.showCircularIcon ? 0.0 : -12.0
    ...
    override open func viewDidAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(YBAlertView.keyboardWillShow(_:)), name:NSNotification.Name.UIKeyboardWillShow, object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(YBAlertView.keyboardWillHide(_:)), name:NSNotification.Name.UIKeyboardWillHide, object: nil);
    }
    ...
    @discardableResult
    open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showTimeout:YBButton.ShowTimeoutConfiguration? = nil, action:@escaping ()->Void)->YBButton {
        let btn = addButton(title, backgroundColor: backgroundColor, textColor: textColor, showTimeout: showTimeout)
        btn.actionType = YBActionType.closure
        btn.action = action
        btn.addTarget(self, action:#selector(YBAlertView.buttonTapped(_:)), for:.touchUpInside)
        btn.addTarget(self, action:#selector(YBAlertView.buttonTapDown(_:)), for:[.touchDown, .touchDragEnter])
        btn.addTarget(self, action:#selector(YBAlertView.buttonRelease(_:)), for:[.touchUpInside, .touchUpOutside, .touchCancel, .touchDragOutside] )
        return btn
    }
    
    @discardableResult
    open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showTimeout:YBButton.ShowTimeoutConfiguration? = nil, target:AnyObject, selector:Selector)->YBButton {
        let btn = addButton(title, backgroundColor: backgroundColor, textColor: textColor, showTimeout: showTimeout)
        btn.actionType = YBActionType.selector
        btn.target = target
    ...
    @discardableResult
    fileprivate func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showTimeout:YBButton.ShowTimeoutConfiguration? = nil)->YBButton {
        // Update view height
    ...
    @objc func buttonTapped(_ btn:YBButton) {
        if btn.actionType == YBActionType.closure {
            btn.action()
        } else if btn.actionType == YBActionType.selector {
            let ctrl = UIControl()
    ...
    @objc func buttonTapDown(_ btn:YBButton) {
        var hue : CGFloat = 0
    ...
    @objc func buttonRelease(_ btn:YBButton) {
    ...
    @discardableResult
    open func showCustom(_ title: String, subTitle: String? = nil, color: UIColor, closeButtonTitle:String?=nil, timeout:YBTimeoutConfiguration?=nil, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: YBAnimationStyle = .topToBottom) -> YBAlertViewResponder {
    ...
    @discardableResult
    open func showSuccess(_ title: String, subTitle: String? = nil, closeButtonTitle:String?=nil, timeout:YBTimeoutConfiguration?=nil, colorStyle: UInt=YBAlertViewStyle.success.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: YBAnimationStyle = .topToBottom) -> YBAlertViewResponder {
    ...
    @discardableResult
    open func showError(_ title: String, subTitle: String? = nil, closeButtonTitle:String?=nil, timeout:YBTimeoutConfiguration?=nil, colorStyle: UInt=YBAlertViewStyle.error.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: YBAnimationStyle = .topToBottom) -> YBAlertViewResponder {
    ...
    @discardableResult
    open func showNotice(_ title: String, subTitle: String? = nil, closeButtonTitle:String?=nil, timeout:YBTimeoutConfiguration?=nil, colorStyle: UInt=YBAlertViewStyle.notice.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: YBAnimationStyle = .topToBottom) -> YBAlertViewResponder {
    ...
    @discardableResult
    open func showWarning(_ title: String, subTitle: String? = nil, closeButtonTitle:String?=nil, timeout:YBTimeoutConfiguration?=nil, colorStyle: UInt=YBAlertViewStyle.warning.defaultColorInt, colorTextButton: UInt=0x000000, circleIconImage: UIImage? = nil, animationStyle: YBAnimationStyle = .topToBottom) ->YBAlertViewResponder {
    ...
    @discardableResult
    open func showInfo(_ title: String, subTitle: String? = nil, closeButtonTitle:String?=nil, timeout:YBTimeoutConfiguration?=nil, colorStyle: UInt=YBAlertViewStyle.info.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: YBAnimationStyle = .topToBottom) -> YBAlertViewResponder {
    ...
    @discardableResult
    open func showWait(_ title: String, subTitle: String? = nil, closeButtonTitle:String?=nil, timeout:YBTimeoutConfiguration?=nil, colorStyle: UInt?=YBAlertViewStyle.wait.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: YBAnimationStyle = .topToBottom) -> YBAlertViewResponder {
    ...
    @discardableResult
    open func showEdit(_ title: String, subTitle: String? = nil, closeButtonTitle:String?=nil, timeout:YBTimeoutConfiguration?=nil, colorStyle: UInt=YBAlertViewStyle.edit.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: YBAnimationStyle = .topToBottom) -> YBAlertViewResponder {
    ...
    @discardableResult
    open func showTitle(_ title: String, subTitle: String? = nil, style: YBAlertViewStyle, closeButtonTitle:String?=nil, timeout:YBTimeoutConfiguration?=nil, colorStyle: UInt?=0x000000, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: YBAnimationStyle = .topToBottom) -> YBAlertViewResponder {
    ...
    @discardableResult
    open func showTitle(_ title: String, subTitle: String? = nil, timeout: YBTimeoutConfiguration?, completeText: String?, style: YBAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: YBAnimationStyle = .topToBottom) -> YBAlertViewResponder {
        selfReference = self
        view.alpha = 0
        view.tag = uniqueTag
        ...
        case .success:
            ...
            iconImage = checkCircleIconImage(circleIconImage, defaultImage: YBAlertViewStyleKit.imageOfCheckmark)
            
        case .error:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage: YBAlertViewStyleKit.imageOfCross)
            
        case .notice:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:YBAlertViewStyleKit.imageOfNotice)
            
        case .warning:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:YBAlertViewStyleKit.imageOfWarning)
            
        case .info:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:YBAlertViewStyleKit.imageOfInfo)
            
        case .edit:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:YBAlertViewStyleKit.imageOfEdit)
            
        case .wait:
            iconImage = nil
            
        case .question:
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:YBAlertViewStyleKit.imageOfQuestion)
        }
        ...
        if appearance.showCloseButton {
            _ = addButton(completeText ?? "Done", target:self, selector:#selector(YBAlertView.hideView))
        }
        ...
        if let timeout = timeout {
            ...
            timeoutTimer = Timer.scheduledTimer(timeInterval: timeout.value, target: self, selector: #selector(YBAlertView.hideViewTimeout), userInfo: nil, repeats: false)
            showTimeoutTimer?.invalidate()
            showTimeoutTimer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(YBAlertView.updateShowTimeout), userInfo: nil, repeats: true)
        }
        ...
        // Chainable objects
        return YBAlertViewResponder(alertview: self)
    }
    
    // Show animation in the alert view
    fileprivate func showAnimation(_ animationStyle: YBAnimationStyle = .topToBottom, animationStartOffset: CGFloat = -400.0, boundingAnimationOffset: CGFloat = 15.0, animationDuration: TimeInterval = 0.2) {
...
class YBAlertViewStyleKit : NSObject {
    ...
    class var imageOfCheckmark: UIImage {
        ...
        YBAlertViewStyleKit.drawCheckmark()
    ...
    class var imageOfNotice: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        YBAlertViewStyleKit.drawNotice()
    ...
    class var imageOfWarning: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        YBAlertViewStyleKit.drawWarning()
    ...
    class var imageOfQuestion: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        YBAlertViewStyleKit.drawQuestion()
