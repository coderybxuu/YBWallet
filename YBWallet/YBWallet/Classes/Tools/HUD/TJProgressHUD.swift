...
private let yb_topBarTag: Int = 1001
private let yb_showHUDBackColor = UIColor(red:0, green:0, blue:0, alpha: 0.8)
...
class SwiftProgress: NSObject {
    ...
    @discardableResult
    static func wait(_ imageNames: Array<UIImage> = Array<UIImage>(), timeMilliseconds: Int = 0, backgroundColor: UIColor = yb_showHUDBackColor, scale: Double = 1.0) -> UIWindow {
    ...
    static func showText(_ text: String, autoClear: Bool=true, autoClearTime: Int = 2) -> UIWindow {
        ...
        let mainView = UIView()
        mainView.layer.cornerRadius = 12
        mainView.backgroundColor = yb_showHUDBackColor
