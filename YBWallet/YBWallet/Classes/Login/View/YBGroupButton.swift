...
@objc protocol YBGroupAndStreamViewDelegate : NSObjectProtocol {
...
class YBGroupButton: UIView {
    ...
    /// 代理
    public weak var delegate : YBGroupAndStreamViewDelegate?
    ...
    func setupGroupAndStream(content : Array<Any>, titleStr : String, currFrame : CGRect, groupId : Int) -> CGRect{
        ...
        groupTitleLab.center.x = self.center.x
